      ...
      <div className="container mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-12 max-w-5xl mx-auto">
          ...
          <div ref={infoRef} className="reveal-left space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  href="mailto:frantrujillano@taxijerez24h.com"
          ...
          <form
            ...
            className="reveal-right lg:col-span-2 space-y-4"
          >
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <input
                ...
                required
                maxLength={200}
                placeholder={t("contact_destination")}
                className={inputClass}
              />
              <input
                name="passengers"
                ...
                max="9"
                required
                placeholder={t("contact_passengers")}
                className={inputClass}
              />
              <select
                name="vehicle"
