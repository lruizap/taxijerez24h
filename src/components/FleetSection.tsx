    ...
    <section id="fleet" className="section-padding">
      <div className="container mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div
            ref={imgRef}
            className="reveal-left rounded-2xl overflow-hidden shadow-lg group"
          >
            <img
              src={fleetImg}
              alt="Taxi fleet Jerez"
          ...
          <div ref={gridRef} className="reveal-right grid grid-cols-2 gap-4">
            {vehicles.map((v) => (
              <div
                key={v.title}
                className="bg-card rounded-xl p-5 border shadow-sm text-center hover:shadow-md hover:-translate-y-1 transition-all duration-300"
              >
