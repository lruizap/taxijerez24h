      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="animate-fade-in-up">
          <img
            ...
            alt="Taxi Jerez 24H"
            className="w-28 h-auto mx-auto mb-8 drop-shadow-2xl rounded-2xl"
          />
        ...
        <div className="mt-16 flex flex-wrap justify-center gap-6 text-primary-foreground/70 text-sm">
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-secondary" /> 24/7
          </div>
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-secondary" /> WiFi
          </div>
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-secondary" /> GPS
          </div>
        </div>
      </div>
    </section>
